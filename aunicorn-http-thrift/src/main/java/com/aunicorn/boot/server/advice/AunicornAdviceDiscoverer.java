package com.aunicorn.boot.server.advice;

import com.aunicorn.boot.server.service.AunicornService;
import com.aunicorn.boot.server.servlet.AunicornServlet;
...
@Configuration
public class AunicornAdviceDiscoverer extends ServletRegistrationBean {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        Arrays.asList(applicationContext.getBeanNamesForAnnotation(AunicornService.class)).stream().forEach(beanName->{
            ...
            try {
                discovererThrift(servletContext, annotation.value(), applicationContext.getBean(beanName));
    ...
    protected void discovererThrift(ServletContext servletContext, String url, Object handler) throws NoSuchMethodException {
